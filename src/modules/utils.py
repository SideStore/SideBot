...
class Utility(Cog):
    ...
    async def on_thread_create(self, thread):
        ...
        embed.add_field(name="Ensure Your Anisette Server Works",
                        ...
                        inline=False)
        embed.add_field(name="Provide SideStore Log Files or Screenshots",
                        ...
                        inline=False)
        embed.add_field(name="Finally, The Hardest Requirement...",
